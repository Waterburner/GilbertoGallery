...
export default function () {
    return (
        <div className="gallery-container">
            {/* 
// TO DO 
// move gallery-filter-bar to own component
// active filter 
*/}
            <div className="gallery-filter-bar-wrapper">
                <div className="gallery-filter-bar">
                    <div className="filter-bar-btn-wrapper">
                        <div className="filter-bar-btn">all items</div>
                    </div>
                    <div className="filter-bar-btn-wrapper">
                        <div className="filter-bar-btn">for sale</div>
                    </div>
                    <div className="filter-bar-btn-wrapper">
                        <div className="filter-bar-btn">sold</div>
                    </div>
                </div>
            </div>
